            ...
            <AnimatedText>
              <div className="text-center">
                ...
                <p className="text-[18px] md:text-[20px] leading-[1.5] mt-6 max-w-[800px] mx-auto">
                  ...
                  humanitarian demining operations, working tirelessly to
                  restore safety and hope to communities worldwide.
                </p>
              </div>
            </AnimatedText>
          ...
          <AnimatedSection animation="slideRight">
            <div className="flex flex-col gap-6">
              ...
              <div className="space-y-4 text-[16px] md:text-[18px] leading-[1.6]">
                <p>
                  Founded in 2002, our organization emerged from a critical need
                  to address the devastating impact of landmines and unexploded
                  ordnance on civilian populations. What started as a small team
                  of dedicated specialists has grown into one of the world's
                  leading humanitarian demining organizations.
                </p>
                <p>
                  We have successfully cleared over 50,000 hectares of
                  contaminated land across 23 countries, enabling the safe
                  return of displaced families and the restoration of
                  agricultural activities that are vital to local economies.
                </p>
                <p>
                  Our approach combines cutting-edge detection technology with
                  time-tested manual clearance techniques, ensuring the highest
                  safety standards while maintaining operational efficiency.
                </p>
              </div>
            </div>
          </AnimatedSection>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-[16px] md:text-[18px] leading-[1.6]">
                    To eliminate the threat of landmines and unexploded
                    ordnance, restoring safe access to land and enabling
                    communities to rebuild their lives with dignity and
                    security.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-[16px] md:text-[18px] leading-[1.6]">
                    <li>
                      <strong>Safety First:</strong> Every operation prioritizes
                      the protection of our teams and communities
                    </li>
                    <li>
                      <strong>Community Partnership:</strong> We work with local
                      populations as partners, not beneficiaries
                    </li>
                    <li>
                      <strong>Excellence:</strong> We maintain the highest
                      international standards in all our operations
                    </li>
                    <li>
                      <strong>Transparency:</strong> Our work is guided by
        ...
        <div className="mt-20 lg:mt-28">
          <AnimatedText>
            <div className="text-center mb-12">
              <h2 className="text-[32px] md:text-[40px] font-bold leading-[1.2] mb-6">
                Our Impact
              </h2>
              <p className="text-[16px] md:text-[18px] leading-[1.6] max-w-[600px] mx-auto">
                Over two decades of dedicated service has resulted in measurable
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
            <AnimatedSection animation="slideRight">
              <div className="flex-1">
                ...
                <div className="space-y-4 text-[16px] md:text-[18px] leading-[1.6]">
                  <p>
                    Our multidisciplinary team consists of explosive ordnance
                    disposal specialists, engineers, community liaison officers,
                    and humanitarian coordinators. Each team member brings years
                    of field experience and specialized training to ensure safe
                    and effective operations.
                  </p>
                  <p>
                    We invest heavily in continuous training and certification
                    programs, ensuring our staff remain at the forefront of
                    demining technology and best practices. Our local hiring
                    policy also provides sustainable employment opportunities in
                    affected communities.
                  </p>
                  <p>
                    With offices in Geneva, Nairobi, and Phnom Penh, our global
                    network enables rapid deployment and sustained presence in
                    regions where our expertise is most needed.
                  </p>
                </div>
              </div>
            </AnimatedSection>
